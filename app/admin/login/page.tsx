      ...
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md transition-all duration-300 border border-gray-200">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <input 
            ...
            className="border p-3 rounded text-black focus:ring-2 focus:ring-blue-500 outline-none" 
            required 
          />
          ...
          <button 
            type="submit" 
            disabled={loading} 
            className="bg-blue-600 text-white p-3 rounded hover:bg-blue-700 disabled:opacity-50 font-semibold mt-2 transition-colors"
          >
